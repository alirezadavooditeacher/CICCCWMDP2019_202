...
public class ApplicationDriver {
    public static void main(String[] args) {
        Product product = new Product(110, "Diet Pepsi", 2.0f, "USA");
        ...
        Food food101 = new Food(100, "Chicken", 8f, "CANADA", 350, 4, new ArrayList<>(Arrays.asList("chicken", "oil", "cheese")));
        Food food102 = new Food(100, "Chicken", 8f, "CANADA", 350, 4, new ArrayList<>(Arrays.asList("chicken", "oil", "cheese")));
        Food food201 = new Food(101, "Pasta", 18f, "CANADA", 250, 3, new ArrayList<>(Arrays.asList("pasta", "meat", "spinach")));
        Food food202 = new Food(101, "Pasta", 18f, "CANADA", 250, 3, new ArrayList<>(Arrays.asList("pasta", "meat", "spinach")));
